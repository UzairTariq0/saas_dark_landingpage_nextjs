    ...
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        ...
        <div className='flex justify-center mt-8'>
          ...
          <Image src={cursorImage} height='200' width='200' className='absolute right-[476px] top-[108px] hidden sm:inline' alt=''/>
          <Image src={messageImage} height='200' width='200' className='absolute top-[56px] left-[498px] hidden sm:inline' alt=''/>
          </div>
        </div>
